...
import type { RemoteEmbeddingProvider } from '../src/search/provider.js';
...
function createCaptureHandler(
  replayDir: string,
  realProvider: RemoteEmbeddingProvider,
  realKey: string,
) {
...
export function startReplayServer(
  replayDir: string,
  opts?: { capture: true; provider: RemoteEmbeddingProvider; key: string },
